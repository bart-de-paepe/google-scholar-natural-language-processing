...
from app.src.services import natural_language_processing_service
...
class Container(containers.DeclarativeContainer):
    ...
    natural_language_processing_service = providers.Factory(
        natural_language_processing_service.NaturalLanguageProcessingService,
        db_service=db_service,
        logging_service=logging_service,
    )